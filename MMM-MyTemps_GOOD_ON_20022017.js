...
Module.register("MMM-MyTemps", {
    ...
    getDom: function () {
        ...
        caption.innerHTML = "<span style=\"color:green\">" + "Garden: " + this.temps.celsius + "°C / " + this.temps.fahrenheit + "°F";
        wrapper.appendChild(caption);
		wrapper.className = "small";         
        
        var caption2 = document.createElement("div");
        caption2.classList.add("title");
        caption2.innerHTML = "<span style=\"color:blue\">" + "Garage: " + this.temps.celsius2 + "°C / " + this.temps.fahrenheit2 + "°F";
